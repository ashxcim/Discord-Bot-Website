                    ...
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                ...
                                <p className="font-semibold text-xl text-white">Nuhz Bot</p>
                            </div>
...
<a href="https://top.gg/user/180320834068819968">
  <img src={"https://top.gg/api/widget/owner/924325576095973426.svg"}/>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://discord.gg/VuxAwpEqws" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Support Server
                                </a>
                            </div>
                            <div>
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; Nuhz Bot
                        </p>
