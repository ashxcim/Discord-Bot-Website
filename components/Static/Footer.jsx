                    ...
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                ...
                                <p className="font-semibold text-xl text-white">Alisa Bot</p>
                            </div>
...
<a href="https://top.gg/api/widget/owner/924325576095973426.svg">
...
<div className="py-1"></div>
<a href="https://top.gg/user/180320834068819968">
  <img src={"https://top.gg/api/widget/owner/924325576095973426.svg"}/>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://discord.gg/3PXwCzS6n" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Support Server
                                </a>
                            </div>
                            <div>
                                <a href=" https://discord.com/api/oauth2/authorize?client_id=884215456670572575&permissions=8&scope=bot%20applications.commands" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Invite Bot
                                </a>
                            </div>
                        </div>
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://github.com/ashxcim?tab=overview&from=2022-11-01&to=2022-11-30">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                            ...
                            <div>
                                <Link href="https://www.youtube.com/channel/UCQoCTiM9FHwEky0EU4tJV8A">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; Alisa Bot
                        </p>
