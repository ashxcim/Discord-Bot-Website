                            ...
                            <Menu as="div" className="relative mt-3 inline-block text-left">
                                <div>
                                    <Menu.Button className="flex z-1 items-center w-full px-4 py-2 text-sm font-medium text-white bg-black rounded-md bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                                        <img
                                            src={`https://cdn.discordapp.com/attachments/1102685799226552341/1109846469701288018/Flag_of_Turkey.svg.png`}
                                            width="24"
                                            height="18"
...
<a href="https://top.gg/user/180320834068819968">
  <img src={"https://top.gg/api/widget/owner/924325576095973426.svg"}/>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://discord.gg/pxBda9JnJv" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Destek Server
                                </a>
                            </div>
                            <div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://discord.gg/pxBda9JnJv">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
